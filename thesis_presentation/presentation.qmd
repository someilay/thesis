...
![Experimental $\color{green}{\mathbf{e}_{\text{SE}(3)}}$, left $\mathbf{e}_c$ - constraint, right $\mathbf{e}_u$ - control](images/figures/errors_history.png){#fig-errors-history width=100%}
